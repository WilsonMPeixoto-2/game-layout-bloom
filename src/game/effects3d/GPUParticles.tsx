...
const PRESET_CONFIGS: Record<string, {
  ...
  sparks: {
    ...
    colors: [
      ...
      new THREE.Color('#18ffff'), new THREE.Color('#ffd740'),
    ],
  ...
  energy: {
    ...
    colors: [
      ...
      new THREE.Color('#b388ff'), new THREE.Color('#69f0ae'),
    ],
    sizeRange: [0.006, 0.022],
    speedRange: [0.03, 0.1],
  ...
  bloom: {
    ...
    colors: [
      ...
      new THREE.Color('#18ffff'), new THREE.Color('#ff6e40'),
      new THREE.Color('#b388ff'), new THREE.Color('#ffd740'),
    ],
    sizeRange: [0.004, 0.024],
    speedRange: [0.02, 0.09],
  ...
  triumph: {
    ...
    colors: [
      ...
      new THREE.Color('#d500f9'), new THREE.Color('#18ffff'),
      new THREE.Color('#ff1744'), new THREE.Color('#ffd54f'),
    ],
    sizeRange: [0.005, 0.035],
