...
export const STORY_SCENES: StoryScene[] = [
  ...
  },
  {
    ...
    background: bgToolkit,
    speaker: 'Sistema',
    dialogue: ['Hora do desafio! Enfrente seus medos!'],
    emotion: 'restoration',
    miniGameSlot: 'courage-challenge',
    autoNext: 'cor_2',
    particles: 'energy',
  },
  {
  ...
  },
  {
    ...
    background: bgRepair,
    speaker: 'Sistema',
    dialogue: ['Hora do desafio! Repita a sequência!'],
    emotion: 'restoration',
    miniGameSlot: 'coop-sequence',
    autoNext: 'coop_2',
    particles: 'energy',
  },
  {
